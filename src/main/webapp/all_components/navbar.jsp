<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
  <a class="navbar-brand" href="#"><i class="fa fa-book mr-1" aria-hidden="true"></i>NOTE-KEEPER</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#"><i class="fa fa-sticky-note mr-1" aria-hidden="true"></i>Show Notes</a>
      </li>
    </ul>
